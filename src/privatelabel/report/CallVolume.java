...
public final class CallVolume extends Report 
{
	...
	public final static LinkedHashMap<String, String> uiSupportedReportTypes = new LinkedHashMap<String, String>()
	{
		private static final long serialVersionUID = 6356735624675832002L;
		{
			put(ReportTypes.STACK_REPORT_NAME, "" +ReportTypes.STACK_REPORT );
			put(ReportTypes.TIME_TREND_REPORT_NAME, "" +ReportTypes.TIME_TREND_REPORT );
		}
	};
