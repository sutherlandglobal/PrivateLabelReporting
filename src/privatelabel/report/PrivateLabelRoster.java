 ...
 *
 */
public final class PrivateLabelRoster extends Roster implements Attributes, Scheduling
{
	
	private final String dbPropFile = Constants.PRIVATE_LABEL_PROD_DB;
	private final static Logger logger = Logger.getLogger(PrivateLabelRoster.class);
	private final static String PROGRAM_NAME = "Private Label";

	private final static String ORGUNIT_NAME = "NATS";

	public static String uiGetReportName()
	{
		return "Private Label Roster";
	}
	 ...
	 */
	public PrivateLabelRoster() throws ReportSetupException 
	{
		super();
	}
	...
	protected boolean setupReport() 
	{
		...
		try
		{
			reportName = PrivateLabelRoster.uiGetReportName();
			reportDesc = PrivateLabelRoster.uiGetReportDesc();
	...
	{		
		...
		{
			setErrorMessage("Error loading schedule");
