 ...
 *
 */
public final class LMICSATRate extends Report 
{
	private final static String SAT_SURVEYS_ATTR = "csatSurveys";
	private final static String ALL_SURVEYS_ATTR = "allSurveys";
