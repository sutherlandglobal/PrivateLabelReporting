...
public class Schedules extends Report 
{
	...
	private final String rocjfsdbs27PropertiesFile = DatabaseConfigs.PRIVATE_LABEL_PROD_DB;
	private final String rocjfsdev18PropertiesFile = DatabaseConfigs.PRIVATE_LABEL_DEV_DB;
